...
public class veterinariaViewController {
    ...
    private void mostrarOpcionesDeGestion(String opcion) {
        switch(opcion) {
            ...
            case "Gestionar Propietarios" -> {
                ...
                consultarPropietarioButton.setOnAction(event -> {
                    mostrarRequisitosDeConsultarPropietario();
                });
            ...
            case "Gestionar Mascotas" -> {
                ...
                crearMascotaButton.setOnAction(event -> {
                    mostrarRequisitosDeCrearMascota();
                });
    ...
    private void mostrarRequisitosDeConsultarPropietario() {
        ...
        buttonConsultarPropietario.setOnAction(event -> {
            if (textFieldNumero.getText().isEmpty()) {
                mostrarAlerta("Campo vacío", "Por favor, ingrese el número del propietario");
            } else {
                consultarPropietario(textFieldNumero.getText());
            }
        });
    ...
    private void consultarPropietario(String numero) {
        Propietario propietarioAConsultar = veterinariaController.consultarPropietario(numero);
        if (propietarioAConsultar == null) {
            mostrarAlerta("Propietario no registrado", "Por favor, verifique el número del propietario");
        } else {
            Alert alert = new Alert(Alert.AlertType.INFORMATION);
            alert.setTitle("Propietario Consultado");
            alert.setHeaderText(null);
            alert.setContentText(propietarioAConsultar.toString());
            alert.showAndWait();
        }
    }

    private void mostrarRequisitosDeAsignarMascota(String numeroPropietario, String idMascota) {

    }



    private void mostrarRequisitosDeCrearMascota() {
        Label gestion = new Label("Crear Mascota");

        Label nombreMascota = new Label("Nombre:");
        TextField textFieldNombreMascota = new TextField();
        Label edadMascota = new Label("Edad:");
        TextField textFieldEdadMascota = new TextField();
        Label pesoMascota = new Label("Peso:");
        TextField textFieldPesoMascota = new TextField();
        Label idMascota = new Label("Id de la mascota:");
        TextField textFieldIdMascota = new TextField();
        Label numeroPropietario = new Label("Numero del propietario:");
        TextField textFieldNumeroPropietario = new TextField();
