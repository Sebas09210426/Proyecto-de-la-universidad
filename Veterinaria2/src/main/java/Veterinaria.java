public class Veterinaria {
    ...
    public boolean agregarPropietario(String nombreMascota, String nombres, String apellidos, String numero, String direccion, int fidelidad) {
        Propietario nuevoPropietario = new Propietario(nombreMascota, nombres, apellidos, numero, direccion, fidelidad);
