        ...
        do {
            ...
            switch (opcion) {
                ...
                case 1:
                    ...
                    //Crear mascota
                    boolean mascotaCreada = nuevaVeterinaria.agregarMascota(nombre,especie,raza,edad,idRegistro);
                    if (mascotaCreada) {
                ...
                case 5:
                    ...
                    //Realizar Registro
                    boolean propietarioAgregado = nuevaVeterinaria.agregarPropietario(mascotaDueno,nombres,apellidos,numero,direccion);
